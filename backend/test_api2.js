...
async function run() {
  ...
  console.log(`Querying API with lat=${lat}, lng=${lng}`);
  
  try {
    const res = await axios.get(`http://localhost:5007/api/consultations/nearby?lat=${lat}&lng=${lng}&radius=20&mode=nearby`, {
