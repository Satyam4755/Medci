  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="flex justify-between items-center p-6 lg:px-12">
        <div className="text-3xl font-bold text-foreground tracking-tight cursor-default">
          Medci
        </div>
        <div className="flex items-center gap-2 md:gap-4">
          <button onClick={() => navigate('/login')} className="px-2 py-2 md:px-4 md:py-2 text-sm md:text-base rounded-lg text-muted-foreground hover:text-foreground transition whitespace-nowrap">Login</button>
      ...
      <main className="flex flex-col items-center justify-center text-center px-6 mt-20 lg:mt-32">
        ...
        >
          <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 text-foreground">
            Real-Time <span className="text-primary">Hair Treatment</span> Consultations
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-xl bg-primary text-primary-foreground font-semibold text-lg shadow-[0_0_20px_rgba(255,255,255,0.1)] transition"
            >
              Find a Doctor Now
            </motion.button>
            <motion.button 
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-xl bg-transparent text-foreground font-semibold text-lg border border-border hover:bg-card transition"
            >
              Are you a Doctor?
            </motion.button>
          </div>
      ...
      <section className="mt-32 px-6 lg:px-12 pb-24 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <motion.div 
            ...
            className="p-8 rounded-2xl bg-card border border-border shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:shadow-[0_4px_30px_rgba(255,255,255,0.03)] transition-all"
          >
